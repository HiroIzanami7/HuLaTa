...
public class Slang_Extreme extends javax.swing.JFrame {

    private javax.swing.Timer timer;
    private int secondsRemaining;
    
    public Slang_Extreme(int extremeseconds) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Slang_Extreme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Slang_Extreme(extremeseconds).setVisible(true);
            }
        });
    }
