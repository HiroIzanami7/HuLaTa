 ...
 * @author Nene
 */
public class Slang_Medium extends javax.swing.JFrame {

    private javax.swing.Timer timer;
    private int secondsRemaining;
    
    public Slang_Medium(int mediumseconds) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Slang_Medium.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Slang_Medium(mediumseconds).setVisible(true);
            }
        });
    }
